...
import { AddEducationScreenProps } from '../../navigation/employee.navigator';
...
export class AddEducationScreen extends React.Component<AddEducationScreenProps & ThemedComponentProps, MyState & any> {
    constructor(props) {
        super(props)
        this.state = {
            userId: '',
            ...
            <SafeAreaLayout
                ...
                >
                    ...
                    <View >
                        ...
                        <View style={styles.textInput}>
                            <Item floatingLabel>
                                <Label>Subject or Degree Held</Label>
                                <TextInput></TextInput>
                            </Item>
                        </View>
