...
import { AddExperienceScreenProps } from '../../navigation/employee.navigator';
...
export class AddExperienceScreen extends React.Component<AddExperienceScreenProps & ThemedComponentProps, MyState & any> {
    constructor(props) {
        super(props)
        this.state = {
            userId: '',
