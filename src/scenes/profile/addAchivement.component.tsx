...
import { AddAchivementScreenProps } from '../../navigation/employee.navigator';
...
export class AddAchivementScreen extends React.Component<AddAchivementScreenProps & ThemedComponentProps, MyState & any> {
    constructor(props) {
        super(props)
        this.state = {
            userId: '',
