...
import { AddProductImageScreenProps } from "../../../navigation/stock.navigator";
...
export class AddProductImageScreen extends Component<AddProductImageScreenProps, ThemedComponentProps & any> {
    constructor(props) {
        super(props);
        this.state = {
